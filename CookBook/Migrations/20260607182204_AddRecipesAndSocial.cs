...
{
    /// <inheritdoc />
    public partial class AddRecipesAndSocial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_AspNetUsers_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MealPlanItems_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeReports", x => x.Id);
                    table.ForeignKey(
                        name: "FK_RecipeReports_AspNetUsers_ReportedById",
                        column: x => x.ReportedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_RecipeReports_AspNetUsers_ResolvedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RecipeToCollections", x => new { x.RecipeId, x.CollectionId });
                    table.ForeignKey(
                        name: "FK_RecipeToCollections_Collections_CollectionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Reviews", x => new { x.RecipeId, x.UserId });
                    table.CheckConstraint("chk_review_rating_range", "[Rating] BETWEEN 1 AND 5");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingListItems", x => new { x.ShoppingListId, x.IngredientId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CommentReports_AspNetUsers_ReportedById",
                        column: x => x.ReportedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_notification_one_target", "(CASE WHEN [RecipeId] IS NOT NULL THEN 1 ELSE 0 END + CASE WHEN [CommentId] IS NOT NULL THEN 1 ELSE 0 END) <= 1");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, "NowyKomentarz" },
                    { 2, "OdpowiedzNaKomentarz" },
                    { 3, "NowaRecenzja" },
                    { 4, "ZgloszenieRozpatrzone" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeImages_RecipeId_Order",
                table: "RecipeImages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeReports_ReportedById",
                table: "RecipeReports",
                column: "ReportedById");

            migrationBuilder.CreateIndex(
                name: "IX_RecipeReports_ResolvedById",
                table: "RecipeReports",
                column: "ResolvedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RecipeToCollections_CollectionId",
